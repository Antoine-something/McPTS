...
Global Program Instance productionNum : MenhirLib.Alphabet.Numbered production :=
  { inj := fun x => match x return _ with
    ...
    | Prod'let_defn'0 => 11%positive
    | Prod'atomic_obj'5 => 12%positive
    | Prod'atomic_obj'4 => 13%positive
    | Prod'atomic_obj'3 => 14%positive
    | Prod'atomic_obj'2 => 15%positive
    | Prod'atomic_obj'1 => 16%positive
    | Prod'atomic_obj'0 => 17%positive
    | Prod'app_obj'1 => 18%positive
    | Prod'app_obj'0 => 19%positive
    | Prod'ann_obj'0 => 20%positive
    end;
    surj := (fun n => match n return _ with
    ...
    | 11%positive => Prod'let_defn'0
    | 12%positive => Prod'atomic_obj'5
    | 13%positive => Prod'atomic_obj'4
    | 14%positive => Prod'atomic_obj'3
    | 15%positive => Prod'atomic_obj'2
    | 16%positive => Prod'atomic_obj'1
    | 17%positive => Prod'atomic_obj'0
    | 18%positive => Prod'app_obj'1
    | 19%positive => Prod'app_obj'0
    | 20%positive => Prod'ann_obj'0
    | _ => Prod'prog'0
    end)%Z;
...
obj
  ...
  | Prod'let_defn'0 => box
    (let_defn'nt, [NT obj'nt; T DEF't; NT param'nt]%list)
    (fun obj _2 param =>
                              ( (param, obj) )
)
  | Prod'obj'0 => box
...
app_obj
  ...
  | Prod'obj'5 => box
    ...
    (fun body _3 ds _1 =>
                                            (Cst.app (Cst.fn (fst (fst ds)) (snd (fst ds)) (snd body) (fst body)) (snd ds) )
)
  | Prod'param'0 => box
...
Definition last_symb_of_non_init_state (noninitstate:noninitstate) : symbol :=
  ...
  | Nis'25 => NT app_obj'nt
  | Nis'26 => NT atomic_obj'nt
  | Nis'27 => NT ann_obj'nt
  | Nis'28 => NT obj'nt
  | Nis'29 => NT let_defn'nt
  | Nis'30 => T IN't
  | Nis'31 => NT ann_obj'nt
  | Nis'32 => NT obj'nt
  | Nis'33 => T RPAREN't
  | Nis'34 => NT params'nt
  | Nis'35 => T ARROW't
...
Definition action_table (state:state) : action :=
  ...
  | Init Init'0 => Lookahead_act (fun terminal:terminal =>
    ...
    | LAMBDA't => Shift_act Nis'15 (eq_refl _)
    | INT't => Shift_act Nis'19 (eq_refl _)
    | _ => Fail_act
    end)
  ...
  | Ninit Nis'13 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | DEF't => Shift_act Nis'14 (eq_refl _)
    | _ => Fail_act
    end)
  ...
  | Ninit Nis'16 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | ARROW't => Shift_act Nis'17 (eq_refl _)
    | _ => Fail_act
    end)
  ...
  | Ninit Nis'19 => Default_reduce_act Prod'atomic_obj'3
  | Ninit Nis'20 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | COLON't => Shift_act Nis'21 (eq_refl _)
    | _ => Fail_act
    end)
  ...
  | Ninit Nis'23 => Default_reduce_act Prod'ann_obj'0
  | Ninit Nis'24 => Default_reduce_act Prod'app_obj'1
  ...
  | Ninit Nis'26 => Default_reduce_act Prod'app_obj'0
  | Ninit Nis'27 => Default_reduce_act Prod'obj'1
  | Ninit Nis'28 => Default_reduce_act Prod'let_defn'0
  ...
  | Ninit Nis'31 => Default_reduce_act Prod'obj'5
  | Ninit Nis'32 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | RPAREN't => Shift_act Nis'33 (eq_refl _)
    | _ => Fail_act
    end)
  | Ninit Nis'33 => Default_reduce_act Prod'param'0
  | Ninit Nis'34 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | LPAREN't => Shift_act Nis'9 (eq_refl _)
    | ARROW't => Shift_act Nis'35 (eq_refl _)
    | _ => Fail_act
    end)
  ...
  | Ninit Nis'36 => Default_reduce_act Prod'obj'0
  | Ninit Nis'37 => Default_reduce_act Prod'params'0
  | Ninit Nis'38 => Default_reduce_act Prod'params'1
  | Ninit Nis'39 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | RETURN't => Shift_act Nis'40 (eq_refl _)
    | _ => Fail_act
    end)
  | Ninit Nis'40 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | VAR't => Shift_act Nis'41 (eq_refl _)
    | _ => Fail_act
    end)
  ...
  | Ninit Nis'43 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | BAR't => Shift_act Nis'44 (eq_refl _)
    | _ => Fail_act
    end)
  | Ninit Nis'44 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | ZERO't => Shift_act Nis'45 (eq_refl _)
    | _ => Fail_act
    end)
  ...
  | Ninit Nis'54 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | END't => Shift_act Nis'55 (eq_refl _)
    | _ => Fail_act
    end)
  ...
  | Ninit Nis'57 => Default_reduce_act Prod'atomic_obj'5
  | Ninit Nis'58 => Default_reduce_act Prod'obj'4
  ...
  | Ninit Nis'62 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | EOF't => Shift_act Nis'63 (eq_refl _)
    | _ => Fail_act
    end)
  | Ninit Nis'63 => Default_reduce_act Prod'prog'0
  end.
...
Definition goto_table (state:state) (nt:nonterminal) :=
  ...
  | Init Init'0, prog'nt => None  | Init Init'0, obj'nt => Some (exist _ Nis'60 (eq_refl _))
  | Init Init'0, atomic_obj'nt => Some (exist _ Nis'24 (eq_refl _))
  | Init Init'0, app_obj'nt => Some (exist _ Nis'25 (eq_refl _))
  | Ninit Nis'4, atomic_obj'nt => Some (exist _ Nis'58 (eq_refl _))
  | Ninit Nis'6, obj'nt => Some (exist _ Nis'56 (eq_refl _))
  | Ninit Nis'6, atomic_obj'nt => Some (exist _ Nis'24 (eq_refl _))
  | Ninit Nis'6, app_obj'nt => Some (exist _ Nis'25 (eq_refl _))
  | Ninit Nis'7, obj'nt => Some (exist _ Nis'39 (eq_refl _))
  | Ninit Nis'7, atomic_obj'nt => Some (exist _ Nis'24 (eq_refl _))
  | Ninit Nis'7, app_obj'nt => Some (exist _ Nis'25 (eq_refl _))
  | Ninit Nis'8, params'nt => Some (exist _ Nis'34 (eq_refl _))
  | Ninit Nis'8, param'nt => Some (exist _ Nis'38 (eq_refl _))
  | Ninit Nis'11, obj'nt => Some (exist _ Nis'32 (eq_refl _))
  | Ninit Nis'11, atomic_obj'nt => Some (exist _ Nis'24 (eq_refl _))
  | Ninit Nis'11, app_obj'nt => Some (exist _ Nis'25 (eq_refl _))
  | Ninit Nis'12, param'nt => Some (exist _ Nis'13 (eq_refl _))
  | Ninit Nis'12, let_defn'nt => Some (exist _ Nis'29 (eq_refl _))
  | Ninit Nis'14, obj'nt => Some (exist _ Nis'28 (eq_refl _))
  | Ninit Nis'14, atomic_obj'nt => Some (exist _ Nis'24 (eq_refl _))
  | Ninit Nis'14, app_obj'nt => Some (exist _ Nis'25 (eq_refl _))
  | Ninit Nis'15, param'nt => Some (exist _ Nis'16 (eq_refl _))
  | Ninit Nis'17, ann_obj'nt => Some (exist _ Nis'27 (eq_refl _))
  | Ninit Nis'18, obj'nt => Some (exist _ Nis'20 (eq_refl _))
  | Ninit Nis'18, atomic_obj'nt => Some (exist _ Nis'24 (eq_refl _))
  | Ninit Nis'18, app_obj'nt => Some (exist _ Nis'25 (eq_refl _))
  | Ninit Nis'21, obj'nt => Some (exist _ Nis'22 (eq_refl _))
  | Ninit Nis'21, atomic_obj'nt => Some (exist _ Nis'24 (eq_refl _))
  | Ninit Nis'21, app_obj'nt => Some (exist _ Nis'25 (eq_refl _))
  | Ninit Nis'25, atomic_obj'nt => Some (exist _ Nis'26 (eq_refl _))
  | Ninit Nis'30, ann_obj'nt => Some (exist _ Nis'31 (eq_refl _))
  | Ninit Nis'34, param'nt => Some (exist _ Nis'37 (eq_refl _))
  | Ninit Nis'35, obj'nt => Some (exist _ Nis'36 (eq_refl _))
  | Ninit Nis'35, atomic_obj'nt => Some (exist _ Nis'24 (eq_refl _))
  | Ninit Nis'35, app_obj'nt => Some (exist _ Nis'25 (eq_refl _))
  | Ninit Nis'42, obj'nt => Some (exist _ Nis'43 (eq_refl _))
  | Ninit Nis'42, atomic_obj'nt => Some (exist _ Nis'24 (eq_refl _))
  | Ninit Nis'42, app_obj'nt => Some (exist _ Nis'25 (eq_refl _))
  | Ninit Nis'46, obj'nt => Some (exist _ Nis'47 (eq_refl _))
  | Ninit Nis'46, atomic_obj'nt => Some (exist _ Nis'24 (eq_refl _))
  | Ninit Nis'46, app_obj'nt => Some (exist _ Nis'25 (eq_refl _))
  | Ninit Nis'53, obj'nt => Some (exist _ Nis'54 (eq_refl _))
  | Ninit Nis'53, atomic_obj'nt => Some (exist _ Nis'24 (eq_refl _))
  | Ninit Nis'53, app_obj'nt => Some (exist _ Nis'25 (eq_refl _))
  | Ninit Nis'61, obj'nt => Some (exist _ Nis'62 (eq_refl _))
  | Ninit Nis'61, atomic_obj'nt => Some (exist _ Nis'24 (eq_refl _))
  | Ninit Nis'61, app_obj'nt => Some (exist _ Nis'25 (eq_refl _))
  | _, _ => None
  end.
...
Definition past_symb_of_non_init_state (noninitstate:noninitstate) : list symbol :=
  ...
  | Nis'17 => [NT param'nt; T LAMBDA't]%list
  | Nis'18 => []%list
  | Nis'19 => []%list
  | Nis'20 => [T LPAREN't]%list
  | Nis'21 => [NT obj'nt; T LPAREN't]%list
  | Nis'22 => [T COLON't; NT obj'nt; T LPAREN't]%list
  | Nis'23 => [NT obj'nt; T COLON't; NT obj'nt; T LPAREN't]%list
  | Nis'24 => []%list
  | Nis'25 => []%list
  | Nis'26 => [NT app_obj'nt]%list
  | Nis'27 => [T ARROW't; NT param'nt; T LAMBDA't]%list
  | Nis'28 => [T DEF't; NT param'nt]%list
  | Nis'29 => [T LET't]%list
  | Nis'30 => [NT let_defn'nt; T LET't]%list
  | Nis'31 => [T IN't; NT let_defn'nt; T LET't]%list
  | Nis'32 => [T COLON't; T VAR't; T LPAREN't]%list
  | Nis'33 => [NT obj'nt; T COLON't; T VAR't; T LPAREN't]%list
  | Nis'34 => [T PI't]%list
  | Nis'35 => [NT params'nt; T PI't]%list
  | Nis'36 => [T ARROW't; NT params'nt; T PI't]%list
  | Nis'37 => [NT params'nt]%list
  | Nis'38 => []%list
  | Nis'39 => [T REC't]%list
  | Nis'40 => [NT obj'nt; T REC't]%list
  | Nis'41 => [T RETURN't; NT obj'nt; T REC't]%list
  | Nis'42 => [T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'43 => [T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'44 => [NT obj'nt; T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'45 => [T BAR't; NT obj'nt; T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'46 => [T ZERO't; T BAR't; NT obj'nt; T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'47 => [T DARROW't; T ZERO't; T BAR't; NT obj'nt; T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'48 => [NT obj'nt; T DARROW't; T ZERO't; T BAR't; NT obj'nt; T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'49 => [T BAR't; NT obj'nt; T DARROW't; T ZERO't; T BAR't; NT obj'nt; T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'50 => [T SUCC't; T BAR't; NT obj'nt; T DARROW't; T ZERO't; T BAR't; NT obj'nt; T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'51 => [T VAR't; T SUCC't; T BAR't; NT obj'nt; T DARROW't; T ZERO't; T BAR't; NT obj'nt; T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'52 => [T COMMA't; T VAR't; T SUCC't; T BAR't; NT obj'nt; T DARROW't; T ZERO't; T BAR't; NT obj'nt; T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'53 => [T VAR't; T COMMA't; T VAR't; T SUCC't; T BAR't; NT obj'nt; T DARROW't; T ZERO't; T BAR't; NT obj'nt; T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'54 => [T DARROW't; T VAR't; T COMMA't; T VAR't; T SUCC't; T BAR't; NT obj'nt; T DARROW't; T ZERO't; T BAR't; NT obj'nt; T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'55 => [NT obj'nt; T DARROW't; T VAR't; T COMMA't; T VAR't; T SUCC't; T BAR't; NT obj'nt; T DARROW't; T ZERO't; T BAR't; NT obj'nt; T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'56 => [T LPAREN't]%list
  | Nis'57 => [NT obj'nt; T LPAREN't]%list
  | Nis'58 => [T SUCC't]%list
  | Nis'60 => []%list
  | Nis'61 => [NT obj'nt]%list
  | Nis'62 => [T COLON't; NT obj'nt]%list
  | Nis'63 => [NT obj'nt; T COLON't; NT obj'nt]%list
  end.
Extract Constant past_symb_of_non_init_state => "fun _ -> assert false".

Definition state_set_1 (s:state) : bool :=
  match s with
  | Init Init'0 | Ninit Nis'4 | Ninit Nis'6 | Ninit Nis'7 | Ninit Nis'11 | Ninit Nis'14 | Ninit Nis'18 | Ninit Nis'21 | Ninit Nis'25 | Ninit Nis'35 | Ninit Nis'42 | Ninit Nis'46 | Ninit Nis'53 | Ninit Nis'61 => true
  | _ => false
  end.
...
Definition state_set_2 (s:state) : bool :=
  match s with
  | Init Init'0 | Ninit Nis'6 | Ninit Nis'7 | Ninit Nis'11 | Ninit Nis'14 | Ninit Nis'18 | Ninit Nis'21 | Ninit Nis'35 | Ninit Nis'42 | Ninit Nis'46 | Ninit Nis'53 | Ninit Nis'61 => true
  | _ => false
  end.
...
Definition state_set_3 (s:state) : bool :=
  match s with
  | Ninit Nis'8 | Ninit Nis'12 | Ninit Nis'15 | Ninit Nis'34 => true
  | _ => false
  end.
...
Definition state_set_10 (s:state) : bool :=
  match s with
  | Ninit Nis'17 | Ninit Nis'30 => true
  | _ => false
  end.
...
Definition past_state_of_non_init_state (s:noninitstate) : list (state -> bool) :=
  ...
  | Nis'16 => [state_set_8; state_set_2]%list
  | Nis'17 => [state_set_9; state_set_8; state_set_2]%list
  | Nis'18 => [state_set_10]%list
  | Nis'19 => [state_set_1]%list
  | Nis'20 => [state_set_11; state_set_10]%list
  | Nis'21 => [state_set_12; state_set_11; state_set_10]%list
  | Nis'22 => [state_set_13; state_set_12; state_set_11; state_set_10]%list
  | Nis'23 => [state_set_14; state_set_13; state_set_12; state_set_11; state_set_10]%list
  | Nis'24 => [state_set_2]%list
  | Nis'25 => [state_set_2]%list
  | Nis'26 => [state_set_15; state_set_2]%list
  | Nis'27 => [state_set_16; state_set_9; state_set_8; state_set_2]%list
  | Nis'28 => [state_set_17; state_set_7; state_set_6]%list
  | Nis'29 => [state_set_6; state_set_2]%list
  | Nis'30 => [state_set_18; state_set_6; state_set_2]%list
  | Nis'31 => [state_set_19; state_set_18; state_set_6; state_set_2]%list
  | Nis'32 => [state_set_20; state_set_5; state_set_4; state_set_3]%list
  | Nis'33 => [state_set_21; state_set_20; state_set_5; state_set_4; state_set_3]%list
  | Nis'34 => [state_set_22; state_set_2]%list
  | Nis'35 => [state_set_23; state_set_22; state_set_2]%list
  | Nis'36 => [state_set_24; state_set_23; state_set_22; state_set_2]%list
  | Nis'37 => [state_set_23; state_set_22]%list
  | Nis'38 => [state_set_22]%list
  | Nis'39 => [state_set_25; state_set_2]%list
  | Nis'40 => [state_set_26; state_set_25; state_set_2]%list
  | Nis'41 => [state_set_27; state_set_26; state_set_25; state_set_2]%list
  | Nis'42 => [state_set_28; state_set_27; state_set_26; state_set_25; state_set_2]%list
  | Nis'43 => [state_set_29; state_set_28; state_set_27; state_set_26; state_set_25; state_set_2]%list
  | Nis'44 => [state_set_30; state_set_29; state_set_28; state_set_27; state_set_26; state_set_25; state_set_2]%list
  | Nis'45 => [state_set_31; state_set_30; state_set_29; state_set_28; state_set_27; state_set_26; state_set_25; state_set_2]%list
  | Nis'46 => [state_set_32; state_set_31; state_set_30; state_set_29; state_set_28; state_set_27; state_set_26; state_set_25; state_set_2]%list
  | Nis'47 => [state_set_33; state_set_32; state_set_31; state_set_30; state_set_29; state_set_28; state_set_27; state_set_26; state_set_25; state_set_2]%list
  | Nis'48 => [state_set_34; state_set_33; state_set_32; state_set_31; state_set_30; state_set_29; state_set_28; state_set_27; state_set_26; state_set_25; state_set_2]%list
  | Nis'49 => [state_set_35; state_set_34; state_set_33; state_set_32; state_set_31; state_set_30; state_set_29; state_set_28; state_set_27; state_set_26; state_set_25; state_set_2]%list
  | Nis'50 => [state_set_36; state_set_35; state_set_34; state_set_33; state_set_32; state_set_31; state_set_30; state_set_29; state_set_28; state_set_27; state_set_26; state_set_25; state_set_2]%list
  | Nis'51 => [state_set_37; state_set_36; state_set_35; state_set_34; state_set_33; state_set_32; state_set_31; state_set_30; state_set_29; state_set_28; state_set_27; state_set_26; state_set_25; state_set_2]%list
  | Nis'52 => [state_set_38; state_set_37; state_set_36; state_set_35; state_set_34; state_set_33; state_set_32; state_set_31; state_set_30; state_set_29; state_set_28; state_set_27; state_set_26; state_set_25; state_set_2]%list
  | Nis'53 => [state_set_39; state_set_38; state_set_37; state_set_36; state_set_35; state_set_34; state_set_33; state_set_32; state_set_31; state_set_30; state_set_29; state_set_28; state_set_27; state_set_26; state_set_25; state_set_2]%list
  | Nis'54 => [state_set_40; state_set_39; state_set_38; state_set_37; state_set_36; state_set_35; state_set_34; state_set_33; state_set_32; state_set_31; state_set_30; state_set_29; state_set_28; state_set_27; state_set_26; state_set_25; state_set_2]%list
  | Nis'55 => [state_set_41; state_set_40; state_set_39; state_set_38; state_set_37; state_set_36; state_set_35; state_set_34; state_set_33; state_set_32; state_set_31; state_set_30; state_set_29; state_set_28; state_set_27; state_set_26; state_set_25; state_set_2]%list
  | Nis'56 => [state_set_42; state_set_1]%list
  | Nis'57 => [state_set_43; state_set_42; state_set_1]%list
  | Nis'58 => [state_set_44; state_set_2]%list
  | Nis'60 => [state_set_45]%list
  | Nis'61 => [state_set_46; state_set_45]%list
  | Nis'62 => [state_set_47; state_set_46; state_set_45]%list
  | Nis'63 => [state_set_48; state_set_47; state_set_46; state_set_45]%list
  end.
...
Definition lookahead_set_4 : list terminal :=
  [ZERO't; VAR't; TYPE't; RPAREN't; RETURN't; NAT't; LPAREN't; INT't; IN't; EOF't; END't; COLON't; BAR't]%list.
...
Definition lookahead_set_14 : list terminal :=
  [ZERO't; VAR't; TYPE't; NAT't; LPAREN't; INT't; IN't]%list.
...
Definition items_of_state_6 : list item :=
  [ {| prod_item := Prod'app_obj'0; dot_pos_item := 0; lookaheads_item := lookahead_set_6 |};
    ...
    {| prod_item := Prod'obj'5; dot_pos_item := 0; lookaheads_item := lookahead_set_7 |} ]%list.
...
Definition items_of_state_7 : list item :=
  [ {| prod_item := Prod'app_obj'0; dot_pos_item := 0; lookaheads_item := lookahead_set_8 |};
    ...
    {| prod_item := Prod'obj'4; dot_pos_item := 0; lookaheads_item := lookahead_set_9 |};
    {| prod_item := Prod'obj'5; dot_pos_item := 0; lookaheads_item := lookahead_set_9 |} ]%list.
...
Definition items_of_state_11 : list item :=
  [ {| prod_item := Prod'app_obj'0; dot_pos_item := 0; lookaheads_item := lookahead_set_6 |};
    ...
    {| prod_item := Prod'obj'3; dot_pos_item := 0; lookaheads_item := lookahead_set_7 |};
    {| prod_item := Prod'obj'4; dot_pos_item := 0; lookaheads_item := lookahead_set_7 |};
    {| prod_item := Prod'obj'5; dot_pos_item := 0; lookaheads_item := lookahead_set_7 |};
    {| prod_item := Prod'param'0; dot_pos_item := 3; lookaheads_item := lookahead_set_11 |} ]%list.
...
Definition items_of_state_12 : list item :=
  [ {| prod_item := Prod'let_defn'0; dot_pos_item := 0; lookaheads_item := lookahead_set_12 |};
    {| prod_item := Prod'obj'5; dot_pos_item := 1; lookaheads_item := lookahead_set_5 |};
...
Definition items_of_state_14 : list item :=
  [ {| prod_item := Prod'app_obj'0; dot_pos_item := 0; lookaheads_item := lookahead_set_14 |};
    ...
    {| prod_item := Prod'obj'5; dot_pos_item := 0; lookaheads_item := lookahead_set_12 |} ]%list.
...
Definition items_of_state_29 : list item :=
  [ {| prod_item := Prod'obj'5; dot_pos_item := 2; lookaheads_item := lookahead_set_5 |} ]%list.
Extract Inlined Constant items_of_state_29 => "assert false".

Definition items_of_state_30 : list item :=
  [ {| prod_item := Prod'ann_obj'0; dot_pos_item := 0; lookaheads_item := lookahead_set_5 |};
    {| prod_item := Prod'obj'5; dot_pos_item := 3; lookaheads_item := lookahead_set_5 |} ]%list.
Extract Inlined Constant items_of_state_30 => "assert false".

Definition items_of_state_31 : list item :=
  [ {| prod_item := Prod'obj'5; dot_pos_item := 4; lookaheads_item := lookahead_set_5 |} ]%list.
...
Definition items_of_state_35 : list item :=
  [ {| prod_item := Prod'app_obj'0; dot_pos_item := 0; lookaheads_item := lookahead_set_4 |};
    ...
    {| prod_item := Prod'obj'4; dot_pos_item := 0; lookaheads_item := lookahead_set_5 |};
    {| prod_item := Prod'obj'5; dot_pos_item := 0; lookaheads_item := lookahead_set_5 |} ]%list.
