...
Global Program Instance nonterminalNum : MenhirLib.Alphabet.Numbered nonterminal :=
  { inj := fun x => match x return _ with
    ...
    | 7%positive => obj'nt
    | 8%positive => param'nt
    | 9%positive => params'nt
    | 10%positive => prog'nt
    | _ => ann_obj'nt
    end)%Z;
    inj_bound := 10%positive }.
...
Global Program Instance productionNum : MenhirLib.Alphabet.Numbered production :=
  { inj := fun x => match x return _ with
    ...
    | Prod'obj'5 => 5%positive
    | Prod'obj'4 => 6%positive
    | Prod'obj'3 => 7%positive
    | Prod'obj'2 => 8%positive
    | Prod'obj'1 => 9%positive
    | Prod'obj'0 => 10%positive
    | Prod'level'0 => 11%positive
    | Prod'let_defns'1 => 12%positive
    | Prod'let_defns'0 => 13%positive
    | Prod'let_defn'0 => 14%positive
    ...
    | 5%positive => Prod'obj'5
    | 6%positive => Prod'obj'4
    | 7%positive => Prod'obj'3
    | 8%positive => Prod'obj'2
    | 9%positive => Prod'obj'1
    | 10%positive => Prod'obj'0
    | 11%positive => Prod'level'0
    | 12%positive => Prod'let_defns'1
    | 13%positive => Prod'let_defns'0
    | 14%positive => Prod'let_defn'0
...
atomic_obj
  ...
  | Prod'atomic_obj'0 => box
    (atomic_obj'nt, [NT level'nt]%list)
    (fun n =>
               ( Cst.s_univ n )
)
...
obj
  ...
  | Prod'level'0 => box
    (level'nt, [T INT't; T AT't; T TYPE't]%list)
    (fun n _2 _1 =>
                        ( snd n )
)
  | Prod'obj'0 => box
    (obj'nt, [NT obj'nt; T ARROW't; NT level'nt; T COLON't; NT params'nt; T PI't]%list)
    (fun obj _5 n _3 params _1 =>
                                                   ( List.fold_left (fun acc arg => Cst.pi (fst arg) n (snd arg) acc) params obj )
)
  | Prod'obj'1 => box
    (obj'nt, [NT ann_obj'nt; T ARROW't; NT level'nt; T COLON't; NT params'nt; T LAMBDA't]%list)
    (fun ann_obj _5 n _3 params _1 =>
                                                           ( 
    fst (
      List.fold_left (
        fun acc arg => (
...
app_obj
  ...
  | Prod'obj'5 => box
    (obj'nt, [NT ann_obj'nt; T IN't; NT level'nt; T COLON't; NT let_defns'nt; T LET't]%list)
    (fun body _5 n _3 ds _1 =>
                                                             ( 
...
Definition last_symb_of_non_init_state (noninitstate:noninitstate) : symbol :=
  ...
  | Nis'36 => NT obj'nt
  | Nis'37 => T RPAREN't
  | Nis'38 => NT let_defns'nt
  | Nis'39 => T COLON't
  | Nis'40 => NT level'nt
  | Nis'41 => T IN't
  | Nis'42 => NT ann_obj'nt
  | Nis'43 => NT let_defn'nt
  | Nis'44 => NT let_defn'nt
  | Nis'45 => NT obj'nt
  | Nis'46 => T RPAREN't
  | Nis'47 => NT params'nt
  | Nis'48 => T COLON't
...
Definition action_table (state:state) : action :=
  ...
  | Init Init'0 => Lookahead_act (fun terminal:terminal =>
    ...
    | REC't => Shift_act Nis'9 (eq_refl _)
    | PI't => Shift_act Nis'10 (eq_refl _)
    | NAT't => Shift_act Nis'7 (eq_refl _)
    | LPAREN't => Shift_act Nis'8 (eq_refl _)
    | LET't => Shift_act Nis'14 (eq_refl _)
  ...
  | Ninit Nis'5 => Default_reduce_act Prod'level'0
  ...
  | Ninit Nis'25 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | COLON't => Shift_act Nis'26 (eq_refl _)
    | _ => Fail_act
    end)
  ...
  | Ninit Nis'28 => Default_reduce_act Prod'ann_obj'0
  | Ninit Nis'29 => Default_reduce_act Prod'atomic_obj'0
  ...
  | Ninit Nis'31 => Lookahead_act (fun terminal:terminal =>
    ...
    | AT't => Reduce_act Prod'obj'2
    | ARROW't => Reduce_act Prod'obj'2
    end)
  | Ninit Nis'32 => Default_reduce_act Prod'app_obj'0
  | Ninit Nis'33 => Default_reduce_act Prod'obj'1
  | Ninit Nis'34 => Default_reduce_act Prod'params'0
  | Ninit Nis'35 => Default_reduce_act Prod'params'1
  | Ninit Nis'36 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | RPAREN't => Shift_act Nis'37 (eq_refl _)
    | _ => Fail_act
    end)
  | Ninit Nis'37 => Default_reduce_act Prod'let_defn'0
  | Ninit Nis'38 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | LPAREN't => Shift_act Nis'15 (eq_refl _)
    | COLON't => Shift_act Nis'39 (eq_refl _)
    | _ => Fail_act
    end)
  ...
  | Ninit Nis'40 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | IN't => Shift_act Nis'41 (eq_refl _)
    | _ => Fail_act
    end)
  ...
  | Ninit Nis'42 => Default_reduce_act Prod'obj'5
  | Ninit Nis'43 => Default_reduce_act Prod'let_defns'0
  | Ninit Nis'44 => Default_reduce_act Prod'let_defns'1
  | Ninit Nis'45 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | RPAREN't => Shift_act Nis'46 (eq_refl _)
    | _ => Fail_act
    end)
  | Ninit Nis'46 => Default_reduce_act Prod'param'0
  | Ninit Nis'47 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | LPAREN't => Shift_act Nis'11 (eq_refl _)
    | COLON't => Shift_act Nis'48 (eq_refl _)
    | _ => Fail_act
    end)
  ...
  | Ninit Nis'49 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | ARROW't => Shift_act Nis'50 (eq_refl _)
    | _ => Fail_act
    end)
  ...
  | Ninit Nis'56 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | BAR't => Shift_act Nis'57 (eq_refl _)
    | _ => Fail_act
    end)
  | Ninit Nis'57 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | ZERO't => Shift_act Nis'58 (eq_refl _)
    | _ => Fail_act
    end)
  | Ninit Nis'58 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | DARROW't => Shift_act Nis'59 (eq_refl _)
    | _ => Fail_act
    end)
  ...
  | Ninit Nis'65 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | DARROW't => Shift_act Nis'66 (eq_refl _)
    | _ => Fail_act
    end)
  ...
  | Ninit Nis'67 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | END't => Shift_act Nis'68 (eq_refl _)
    | _ => Fail_act
    end)
  | Ninit Nis'68 => Default_reduce_act Prod'obj'3
  | Ninit Nis'69 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | RPAREN't => Shift_act Nis'70 (eq_refl _)
    | _ => Fail_act
    end)
  | Ninit Nis'70 => Default_reduce_act Prod'atomic_obj'5
  | Ninit Nis'71 => Default_reduce_act Prod'obj'4
  | Ninit Nis'73 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | COLON't => Shift_act Nis'74 (eq_refl _)
    | _ => Fail_act
    end)
  ...
  | Ninit Nis'75 => Lookahead_act (fun terminal:terminal =>
    match terminal return lookahead_action terminal with
    | EOF't => Shift_act Nis'76 (eq_refl _)
    | _ => Fail_act
    end)
  | Ninit Nis'76 => Default_reduce_act Prod'prog'0
  end.
...
Definition goto_table (state:state) (nt:nonterminal) :=
  ...
  | Init Init'0, prog'nt => None  | Init Init'0, obj'nt => Some (exist _ Nis'73 (eq_refl _))
  | Init Init'0, level'nt => Some (exist _ Nis'29 (eq_refl _))
  | Init Init'0, atomic_obj'nt => Some (exist _ Nis'30 (eq_refl _))
  | Init Init'0, app_obj'nt => Some (exist _ Nis'31 (eq_refl _))
  | Ninit Nis'6, level'nt => Some (exist _ Nis'29 (eq_refl _))
  | Ninit Nis'6, atomic_obj'nt => Some (exist _ Nis'71 (eq_refl _))
  | Ninit Nis'8, obj'nt => Some (exist _ Nis'69 (eq_refl _))
  | Ninit Nis'8, level'nt => Some (exist _ Nis'29 (eq_refl _))
  | Ninit Nis'8, atomic_obj'nt => Some (exist _ Nis'30 (eq_refl _))
  | Ninit Nis'8, app_obj'nt => Some (exist _ Nis'31 (eq_refl _))
  | Ninit Nis'9, obj'nt => Some (exist _ Nis'52 (eq_refl _))
  | Ninit Nis'9, level'nt => Some (exist _ Nis'29 (eq_refl _))
  | Ninit Nis'9, atomic_obj'nt => Some (exist _ Nis'30 (eq_refl _))
  | Ninit Nis'9, app_obj'nt => Some (exist _ Nis'31 (eq_refl _))
  | Ninit Nis'10, params'nt => Some (exist _ Nis'47 (eq_refl _))
  | Ninit Nis'10, param'nt => Some (exist _ Nis'35 (eq_refl _))
  | Ninit Nis'13, obj'nt => Some (exist _ Nis'45 (eq_refl _))
  | Ninit Nis'13, level'nt => Some (exist _ Nis'29 (eq_refl _))
  | Ninit Nis'13, atomic_obj'nt => Some (exist _ Nis'30 (eq_refl _))
  | Ninit Nis'13, app_obj'nt => Some (exist _ Nis'31 (eq_refl _))
  | Ninit Nis'14, let_defns'nt => Some (exist _ Nis'38 (eq_refl _))
  | Ninit Nis'14, let_defn'nt => Some (exist _ Nis'44 (eq_refl _))
  | Ninit Nis'15, param'nt => Some (exist _ Nis'16 (eq_refl _))
  | Ninit Nis'17, obj'nt => Some (exist _ Nis'36 (eq_refl _))
  | Ninit Nis'17, level'nt => Some (exist _ Nis'29 (eq_refl _))
  ...
  | Ninit Nis'18, param'nt => Some (exist _ Nis'35 (eq_refl _))
  | Ninit Nis'19, param'nt => Some (exist _ Nis'34 (eq_refl _))
  | Ninit Nis'20, level'nt => Some (exist _ Nis'21 (eq_refl _))
  | Ninit Nis'22, ann_obj'nt => Some (exist _ Nis'33 (eq_refl _))
  | Ninit Nis'23, obj'nt => Some (exist _ Nis'25 (eq_refl _))
  | Ninit Nis'23, level'nt => Some (exist _ Nis'29 (eq_refl _))
  ...
  | Ninit Nis'26, level'nt => Some (exist _ Nis'29 (eq_refl _))
  | Ninit Nis'26, atomic_obj'nt => Some (exist _ Nis'30 (eq_refl _))
  | Ninit Nis'26, app_obj'nt => Some (exist _ Nis'31 (eq_refl _))
  | Ninit Nis'31, level'nt => Some (exist _ Nis'29 (eq_refl _))
  | Ninit Nis'31, atomic_obj'nt => Some (exist _ Nis'32 (eq_refl _))
  | Ninit Nis'38, let_defn'nt => Some (exist _ Nis'43 (eq_refl _))
  | Ninit Nis'39, level'nt => Some (exist _ Nis'40 (eq_refl _))
  | Ninit Nis'41, ann_obj'nt => Some (exist _ Nis'42 (eq_refl _))
  | Ninit Nis'47, param'nt => Some (exist _ Nis'34 (eq_refl _))
  | Ninit Nis'48, level'nt => Some (exist _ Nis'49 (eq_refl _))
  | Ninit Nis'50, obj'nt => Some (exist _ Nis'51 (eq_refl _))
  | Ninit Nis'50, level'nt => Some (exist _ Nis'29 (eq_refl _))
  | Ninit Nis'50, atomic_obj'nt => Some (exist _ Nis'30 (eq_refl _))
  | Ninit Nis'50, app_obj'nt => Some (exist _ Nis'31 (eq_refl _))
  | Ninit Nis'55, obj'nt => Some (exist _ Nis'56 (eq_refl _))
  | Ninit Nis'55, level'nt => Some (exist _ Nis'29 (eq_refl _))
  | Ninit Nis'55, atomic_obj'nt => Some (exist _ Nis'30 (eq_refl _))
  | Ninit Nis'55, app_obj'nt => Some (exist _ Nis'31 (eq_refl _))
  | Ninit Nis'59, obj'nt => Some (exist _ Nis'60 (eq_refl _))
  | Ninit Nis'59, level'nt => Some (exist _ Nis'29 (eq_refl _))
  | Ninit Nis'59, atomic_obj'nt => Some (exist _ Nis'30 (eq_refl _))
  | Ninit Nis'59, app_obj'nt => Some (exist _ Nis'31 (eq_refl _))
  | Ninit Nis'66, obj'nt => Some (exist _ Nis'67 (eq_refl _))
  | Ninit Nis'66, level'nt => Some (exist _ Nis'29 (eq_refl _))
  | Ninit Nis'66, atomic_obj'nt => Some (exist _ Nis'30 (eq_refl _))
  | Ninit Nis'66, app_obj'nt => Some (exist _ Nis'31 (eq_refl _))
  | Ninit Nis'74, obj'nt => Some (exist _ Nis'75 (eq_refl _))
  | Ninit Nis'74, level'nt => Some (exist _ Nis'29 (eq_refl _))
  | Ninit Nis'74, atomic_obj'nt => Some (exist _ Nis'30 (eq_refl _))
  | Ninit Nis'74, app_obj'nt => Some (exist _ Nis'31 (eq_refl _))
  | _, _ => None
  end.
...
Definition past_symb_of_non_init_state (noninitstate:noninitstate) : list symbol :=
  ...
  | Nis'17 => [NT param'nt; T LPAREN't]%list
  | Nis'18 => []%list
  | Nis'19 => [T LAMBDA't]%list
  | Nis'20 => [NT params'nt; T LAMBDA't]%list
  | Nis'21 => [T COLON't; NT params'nt; T LAMBDA't]%list
  | Nis'22 => [NT level'nt; T COLON't; NT params'nt; T LAMBDA't]%list
  | Nis'23 => []%list
  | Nis'24 => []%list
  | Nis'25 => [T LPAREN't]%list
  | Nis'26 => [NT obj'nt; T LPAREN't]%list
  | Nis'27 => [T COLON't; NT obj'nt; T LPAREN't]%list
  | Nis'28 => [NT obj'nt; T COLON't; NT obj'nt; T LPAREN't]%list
  | Nis'29 => []%list
  | Nis'30 => []%list
  | Nis'31 => []%list
  | Nis'32 => [NT app_obj'nt]%list
  | Nis'33 => [T ARROW't; NT level'nt; T COLON't; NT params'nt; T LAMBDA't]%list
  | Nis'34 => [NT params'nt]%list
  | Nis'35 => []%list
  | Nis'36 => [T DEF't; NT param'nt; T LPAREN't]%list
  | Nis'37 => [NT obj'nt; T DEF't; NT param'nt; T LPAREN't]%list
  | Nis'38 => [T LET't]%list
  | Nis'39 => [NT let_defns'nt; T LET't]%list
  | Nis'40 => [T COLON't; NT let_defns'nt; T LET't]%list
  | Nis'41 => [NT level'nt; T COLON't; NT let_defns'nt; T LET't]%list
  | Nis'42 => [T IN't; NT level'nt; T COLON't; NT let_defns'nt; T LET't]%list
  | Nis'43 => [NT let_defns'nt]%list
  | Nis'44 => []%list
  | Nis'45 => [T COLON't; T VAR't; T LPAREN't]%list
  | Nis'46 => [NT obj'nt; T COLON't; T VAR't; T LPAREN't]%list
  | Nis'47 => [T PI't]%list
  | Nis'48 => [NT params'nt; T PI't]%list
  | Nis'49 => [T COLON't; NT params'nt; T PI't]%list
  | Nis'50 => [NT level'nt; T COLON't; NT params'nt; T PI't]%list
  | Nis'51 => [T ARROW't; NT level'nt; T COLON't; NT params'nt; T PI't]%list
  | Nis'52 => [T REC't]%list
  | Nis'53 => [NT obj'nt; T REC't]%list
  | Nis'54 => [T RETURN't; NT obj'nt; T REC't]%list
  | Nis'55 => [T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'56 => [T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'57 => [NT obj'nt; T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'58 => [T BAR't; NT obj'nt; T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'59 => [T ZERO't; T BAR't; NT obj'nt; T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'60 => [T DARROW't; T ZERO't; T BAR't; NT obj'nt; T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'61 => [NT obj'nt; T DARROW't; T ZERO't; T BAR't; NT obj'nt; T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'62 => [T BAR't; NT obj'nt; T DARROW't; T ZERO't; T BAR't; NT obj'nt; T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'63 => [T SUCC't; T BAR't; NT obj'nt; T DARROW't; T ZERO't; T BAR't; NT obj'nt; T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'64 => [T VAR't; T SUCC't; T BAR't; NT obj'nt; T DARROW't; T ZERO't; T BAR't; NT obj'nt; T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'65 => [T COMMA't; T VAR't; T SUCC't; T BAR't; NT obj'nt; T DARROW't; T ZERO't; T BAR't; NT obj'nt; T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'66 => [T VAR't; T COMMA't; T VAR't; T SUCC't; T BAR't; NT obj'nt; T DARROW't; T ZERO't; T BAR't; NT obj'nt; T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'67 => [T DARROW't; T VAR't; T COMMA't; T VAR't; T SUCC't; T BAR't; NT obj'nt; T DARROW't; T ZERO't; T BAR't; NT obj'nt; T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'68 => [NT obj'nt; T DARROW't; T VAR't; T COMMA't; T VAR't; T SUCC't; T BAR't; NT obj'nt; T DARROW't; T ZERO't; T BAR't; NT obj'nt; T DOT't; T VAR't; T RETURN't; NT obj'nt; T REC't]%list
  | Nis'69 => [T LPAREN't]%list
  | Nis'70 => [NT obj'nt; T LPAREN't]%list
  | Nis'71 => [T SUCC't]%list
  | Nis'73 => []%list
  | Nis'74 => [NT obj'nt]%list
  | Nis'75 => [T COLON't; NT obj'nt]%list
  | Nis'76 => [NT obj'nt; T COLON't; NT obj'nt]%list
  end.
Extract Constant past_symb_of_non_init_state => "fun _ -> assert false".

Definition state_set_1 (s:state) : bool :=
  match s with
  | Init Init'0 | Ninit Nis'6 | Ninit Nis'8 | Ninit Nis'9 | Ninit Nis'13 | Ninit Nis'17 | Ninit Nis'23 | Ninit Nis'26 | Ninit Nis'31 | Ninit Nis'50 | Ninit Nis'55 | Ninit Nis'59 | Ninit Nis'66 | Ninit Nis'74 => true
  | _ => false
  end.
...
Definition state_set_2 (s:state) : bool :=
  match s with
  | Init Init'0 | Ninit Nis'6 | Ninit Nis'8 | Ninit Nis'9 | Ninit Nis'13 | Ninit Nis'17 | Ninit Nis'20 | Ninit Nis'23 | Ninit Nis'26 | Ninit Nis'31 | Ninit Nis'39 | Ninit Nis'48 | Ninit Nis'50 | Ninit Nis'55 | Ninit Nis'59 | Ninit Nis'66 | Ninit Nis'74 => true
  | _ => false
  end.
...
Definition state_set_5 (s:state) : bool :=
  match s with
  | Init Init'0 | Ninit Nis'8 | Ninit Nis'9 | Ninit Nis'13 | Ninit Nis'17 | Ninit Nis'23 | Ninit Nis'26 | Ninit Nis'50 | Ninit Nis'55 | Ninit Nis'59 | Ninit Nis'66 | Ninit Nis'74 => true
  | _ => false
  end.
...
Definition state_set_6 (s:state) : bool :=
  match s with
  | Ninit Nis'10 | Ninit Nis'15 | Ninit Nis'18 | Ninit Nis'19 | Ninit Nis'47 => true
  | _ => false
  end.
...
Definition state_set_9 (s:state) : bool :=
  match s with
  | Ninit Nis'14 | Ninit Nis'38 => true
  | _ => false
  end.
...
Definition state_set_16 (s:state) : bool :=
  match s with
  | Ninit Nis'22 | Ninit Nis'41 => true
  | _ => false
  end.
...
Definition state_set_23 (s:state) : bool :=
  match s with
  | Ninit Nis'10 | Ninit Nis'18 => true
  | _ => false
  end.
...
Definition state_set_24 (s:state) : bool :=
  match s with
  | Ninit Nis'19 | Ninit Nis'47 => true
  | _ => false
  end.
...
Definition past_state_of_non_init_state (s:noninitstate) : list (state -> bool) :=
  ...
  | Nis'4 => [state_set_3; state_set_2]%list
  | Nis'5 => [state_set_4; state_set_3; state_set_2]%list
  | Nis'6 => [state_set_5]%list
  | Nis'7 => [state_set_1]%list
  | Nis'8 => [state_set_1]%list
  | Nis'9 => [state_set_5]%list
  | Nis'10 => [state_set_5]%list
  | Nis'11 => [state_set_6]%list
  | Nis'12 => [state_set_7; state_set_6]%list
  | Nis'13 => [state_set_8; state_set_7; state_set_6]%list
  | Nis'14 => [state_set_5]%list
  | Nis'15 => [state_set_9]%list
  | Nis'16 => [state_set_10; state_set_9]%list
  | Nis'17 => [state_set_11; state_set_10; state_set_9]%list
  | Nis'18 => [state_set_5]%list
  | Nis'19 => [state_set_12; state_set_5]%list
  | Nis'20 => [state_set_13; state_set_12; state_set_5]%list
  | Nis'21 => [state_set_14; state_set_13; state_set_12; state_set_5]%list
  | Nis'22 => [state_set_15; state_set_14; state_set_13; state_set_12; state_set_5]%list
  | Nis'23 => [state_set_16]%list
  | Nis'24 => [state_set_1]%list
  | Nis'25 => [state_set_17; state_set_16]%list
  | Nis'26 => [state_set_18; state_set_17; state_set_16]%list
  | Nis'27 => [state_set_19; state_set_18; state_set_17; state_set_16]%list
  | Nis'28 => [state_set_20; state_set_19; state_set_18; state_set_17; state_set_16]%list
  | Nis'29 => [state_set_1]%list
  | Nis'30 => [state_set_5]%list
  | Nis'31 => [state_set_5]%list
  | Nis'32 => [state_set_21; state_set_5]%list
  | Nis'33 => [state_set_22; state_set_15; state_set_14; state_set_13; state_set_12; state_set_5]%list
  | Nis'34 => [state_set_24; state_set_23]%list
  | Nis'35 => [state_set_23]%list
  | Nis'36 => [state_set_25; state_set_11; state_set_10; state_set_9]%list
  | Nis'37 => [state_set_26; state_set_25; state_set_11; state_set_10; state_set_9]%list
  | Nis'38 => [state_set_27; state_set_5]%list
  | Nis'39 => [state_set_28; state_set_27; state_set_5]%list
  | Nis'40 => [state_set_29; state_set_28; state_set_27; state_set_5]%list
  | Nis'41 => [state_set_30; state_set_29; state_set_28; state_set_27; state_set_5]%list
  | Nis'42 => [state_set_31; state_set_30; state_set_29; state_set_28; state_set_27; state_set_5]%list
  | Nis'43 => [state_set_28; state_set_27]%list
  | Nis'44 => [state_set_27]%list
  | Nis'45 => [state_set_32; state_set_8; state_set_7; state_set_6]%list
  | Nis'46 => [state_set_33; state_set_32; state_set_8; state_set_7; state_set_6]%list
  | Nis'47 => [state_set_34; state_set_5]%list
  | Nis'48 => [state_set_35; state_set_34; state_set_5]%list
  | Nis'49 => [state_set_36; state_set_35; state_set_34; state_set_5]%list
  | Nis'50 => [state_set_37; state_set_36; state_set_35; state_set_34; state_set_5]%list
  | Nis'51 => [state_set_38; state_set_37; state_set_36; state_set_35; state_set_34; state_set_5]%list
  | Nis'52 => [state_set_39; state_set_5]%list
  | Nis'53 => [state_set_40; state_set_39; state_set_5]%list
  | Nis'54 => [state_set_41; state_set_40; state_set_39; state_set_5]%list
  | Nis'55 => [state_set_42; state_set_41; state_set_40; state_set_39; state_set_5]%list
  | Nis'56 => [state_set_43; state_set_42; state_set_41; state_set_40; state_set_39; state_set_5]%list
  | Nis'57 => [state_set_44; state_set_43; state_set_42; state_set_41; state_set_40; state_set_39; state_set_5]%list
  | Nis'58 => [state_set_45; state_set_44; state_set_43; state_set_42; state_set_41; state_set_40; state_set_39; state_set_5]%list
  | Nis'59 => [state_set_46; state_set_45; state_set_44; state_set_43; state_set_42; state_set_41; state_set_40; state_set_39; state_set_5]%list
  | Nis'60 => [state_set_47; state_set_46; state_set_45; state_set_44; state_set_43; state_set_42; state_set_41; state_set_40; state_set_39; state_set_5]%list
  | Nis'61 => [state_set_48; state_set_47; state_set_46; state_set_45; state_set_44; state_set_43; state_set_42; state_set_41; state_set_40; state_set_39; state_set_5]%list
  | Nis'62 => [state_set_49; state_set_48; state_set_47; state_set_46; state_set_45; state_set_44; state_set_43; state_set_42; state_set_41; state_set_40; state_set_39; state_set_5]%list
  | Nis'63 => [state_set_50; state_set_49; state_set_48; state_set_47; state_set_46; state_set_45; state_set_44; state_set_43; state_set_42; state_set_41; state_set_40; state_set_39; state_set_5]%list
  | Nis'64 => [state_set_51; state_set_50; state_set_49; state_set_48; state_set_47; state_set_46; state_set_45; state_set_44; state_set_43; state_set_42; state_set_41; state_set_40; state_set_39; state_set_5]%list
  | Nis'65 => [state_set_52; state_set_51; state_set_50; state_set_49; state_set_48; state_set_47; state_set_46; state_set_45; state_set_44; state_set_43; state_set_42; state_set_41; state_set_40; state_set_39; state_set_5]%list
  | Nis'66 => [state_set_53; state_set_52; state_set_51; state_set_50; state_set_49; state_set_48; state_set_47; state_set_46; state_set_45; state_set_44; state_set_43; state_set_42; state_set_41; state_set_40; state_set_39; state_set_5]%list
  | Nis'67 => [state_set_54; state_set_53; state_set_52; state_set_51; state_set_50; state_set_49; state_set_48; state_set_47; state_set_46; state_set_45; state_set_44; state_set_43; state_set_42; state_set_41; state_set_40; state_set_39; state_set_5]%list
  | Nis'68 => [state_set_55; state_set_54; state_set_53; state_set_52; state_set_51; state_set_50; state_set_49; state_set_48; state_set_47; state_set_46; state_set_45; state_set_44; state_set_43; state_set_42; state_set_41; state_set_40; state_set_39; state_set_5]%list
  | Nis'69 => [state_set_56; state_set_1]%list
  | Nis'70 => [state_set_57; state_set_56; state_set_1]%list
  | Nis'71 => [state_set_58; state_set_5]%list
  | Nis'73 => [state_set_59]%list
  | Nis'74 => [state_set_60; state_set_59]%list
  | Nis'75 => [state_set_61; state_set_60; state_set_59]%list
  | Nis'76 => [state_set_62; state_set_61; state_set_60; state_set_59]%list
  end.
...
Definition lookahead_set_3 : list terminal :=
  [ZERO't; VAR't; TYPE't; SUCC't; RPAREN't; RETURN't; REC't; PI't; NAT't; LPAREN't; LET't; LAMBDA't; INT't; IN't; EOF't; END't; DOT't; DEF't; DARROW't; COMMA't; COLON't; BAR't; AT't; ARROW't]%list.
...
Definition lookahead_set_5 : list terminal :=
  [ZERO't; VAR't; TYPE't; RPAREN't; RETURN't; NAT't; LPAREN't; INT't; IN't; EOF't; END't; COLON't; BAR't; ARROW't]%list.
...
Definition items_of_state_0 : list item :=
  [ {| prod_item := Prod'app_obj'0; dot_pos_item := 0; lookaheads_item := lookahead_set_1 |};
    ...
    {| prod_item := Prod'level'0; dot_pos_item := 0; lookaheads_item := lookahead_set_1 |};
...
Definition items_of_state_3 : list item :=
  [ {| prod_item := Prod'level'0; dot_pos_item := 1; lookaheads_item := lookahead_set_5 |} ]%list.
Extract Inlined Constant items_of_state_3 => "assert false".

Definition items_of_state_4 : list item :=
  [ {| prod_item := Prod'level'0; dot_pos_item := 2; lookaheads_item := lookahead_set_5 |} ]%list.
Extract Inlined Constant items_of_state_4 => "assert false".

Definition items_of_state_5 : list item :=
  [ {| prod_item := Prod'level'0; dot_pos_item := 3; lookaheads_item := lookahead_set_5 |} ]%list.
...
Definition items_of_state_6 : list item :=
  [ {| prod_item := Prod'atomic_obj'0; dot_pos_item := 0; lookaheads_item := lookahead_set_6 |};
    ...
    {| prod_item := Prod'level'0; dot_pos_item := 0; lookaheads_item := lookahead_set_6 |};
...
Definition items_of_state_8 : list item :=
  [ {| prod_item := Prod'app_obj'0; dot_pos_item := 0; lookaheads_item := lookahead_set_7 |};
    ...
    {| prod_item := Prod'level'0; dot_pos_item := 0; lookaheads_item := lookahead_set_7 |};
    ...
    {| prod_item := Prod'obj'5; dot_pos_item := 0; lookaheads_item := lookahead_set_8 |} ]%list.
...
Definition items_of_state_9 : list item :=
  [ {| prod_item := Prod'app_obj'0; dot_pos_item := 0; lookaheads_item := lookahead_set_9 |};
    ...
    {| prod_item := Prod'level'0; dot_pos_item := 0; lookaheads_item := lookahead_set_9 |};
    ...
    {| prod_item := Prod'obj'5; dot_pos_item := 0; lookaheads_item := lookahead_set_10 |} ]%list.
...
Definition items_of_state_11 : list item :=
  [ {| prod_item := Prod'param'0; dot_pos_item := 1; lookaheads_item := lookahead_set_12 |} ]%list.
Extract Inlined Constant items_of_state_11 => "assert false".

Definition items_of_state_12 : list item :=
  [ {| prod_item := Prod'param'0; dot_pos_item := 2; lookaheads_item := lookahead_set_12 |} ]%list.
...
Definition items_of_state_13 : list item :=
  [ {| prod_item := Prod'app_obj'0; dot_pos_item := 0; lookaheads_item := lookahead_set_7 |};
    ...
    {| prod_item := Prod'param'0; dot_pos_item := 3; lookaheads_item := lookahead_set_12 |} ]%list.
...
Definition items_of_state_19 : list item :=
  [ {| prod_item := Prod'obj'1; dot_pos_item := 2; lookaheads_item := lookahead_set_6 |};
    {| prod_item := Prod'param'0; dot_pos_item := 0; lookaheads_item := lookahead_set_11 |};
...
Definition items_of_state_20 : list item :=
  [ {| prod_item := Prod'level'0; dot_pos_item := 0; lookaheads_item := lookahead_set_14 |};
    {| prod_item := Prod'obj'1; dot_pos_item := 3; lookaheads_item := lookahead_set_6 |} ]%list.
...
Definition items_of_state_23 : list item :=
  [ {| prod_item := Prod'ann_obj'0; dot_pos_item := 1; lookaheads_item := lookahead_set_6 |};
    ...
    {| prod_item := Prod'obj'3; dot_pos_item := 0; lookaheads_item := lookahead_set_2 |};
    {| prod_item := Prod'obj'4; dot_pos_item := 0; lookaheads_item := lookahead_set_2 |};
    {| prod_item := Prod'obj'5; dot_pos_item := 0; lookaheads_item := lookahead_set_2 |} ]%list.
...
Definition items_of_state_31 : list item :=
  [ {| prod_item := Prod'app_obj'0; dot_pos_item := 1; lookaheads_item := lookahead_set_4 |};
    ...
    {| prod_item := Prod'level'0; dot_pos_item := 0; lookaheads_item := lookahead_set_4 |};
    {| prod_item := Prod'obj'2; dot_pos_item := 1; lookaheads_item := lookahead_set_6 |} ]%list.
...
Definition items_of_state_39 : list item :=
  [ {| prod_item := Prod'level'0; dot_pos_item := 0; lookaheads_item := lookahead_set_15 |};
...
Definition items_of_state_41 : list item :=
  [ {| prod_item := Prod'ann_obj'0; dot_pos_item := 0; lookaheads_item := lookahead_set_6 |};
    {| prod_item := Prod'obj'5; dot_pos_item := 5; lookaheads_item := lookahead_set_6 |} ]%list.
Extract Inlined Constant items_of_state_41 => "assert false".

Definition items_of_state_42 : list item :=
  [ {| prod_item := Prod'obj'5; dot_pos_item := 6; lookaheads_item := lookahead_set_6 |} ]%list.
...
Definition items_of_state_45 : list item :=
  [ {| prod_item := Prod'param'0; dot_pos_item := 4; lookaheads_item := lookahead_set_12 |} ]%list.
Extract Inlined Constant items_of_state_45 => "assert false".

Definition items_of_state_46 : list item :=
  [ {| prod_item := Prod'param'0; dot_pos_item := 5; lookaheads_item := lookahead_set_12 |} ]%list.
...
Definition items_of_state_48 : list item :=
  [ {| prod_item := Prod'level'0; dot_pos_item := 0; lookaheads_item := lookahead_set_14 |};
    {| prod_item := Prod'obj'0; dot_pos_item := 3; lookaheads_item := lookahead_set_6 |} ]%list.
...
Definition items_of_state_50 : list item :=
  [ {| prod_item := Prod'app_obj'0; dot_pos_item := 0; lookaheads_item := lookahead_set_4 |};
    ...
    {| prod_item := Prod'obj'5; dot_pos_item := 0; lookaheads_item := lookahead_set_6 |} ]%list.
...
Definition items_of_state_55 : list item :=
  [ {| prod_item := Prod'app_obj'0; dot_pos_item := 0; lookaheads_item := lookahead_set_16 |};
    ...
    {| prod_item := Prod'level'0; dot_pos_item := 0; lookaheads_item := lookahead_set_16 |};
    ...
    {| prod_item := Prod'obj'5; dot_pos_item := 0; lookaheads_item := lookahead_set_17 |} ]%list.
...
Definition items_of_state_66 : list item :=
  [ {| prod_item := Prod'app_obj'0; dot_pos_item := 0; lookaheads_item := lookahead_set_18 |};
    ...
    {| prod_item := Prod'level'0; dot_pos_item := 0; lookaheads_item := lookahead_set_18 |};
    ...
    {| prod_item := Prod'obj'5; dot_pos_item := 0; lookaheads_item := lookahead_set_19 |} ]%list.
...
Definition items_of_state_74 : list item :=
  [ {| prod_item := Prod'app_obj'0; dot_pos_item := 0; lookaheads_item := lookahead_set_20 |};
    ...
    {| prod_item := Prod'level'0; dot_pos_item := 0; lookaheads_item := lookahead_set_20 |};
