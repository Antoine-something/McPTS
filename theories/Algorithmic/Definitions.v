...
Reserved Notation "Γ '⊢a' M ⟹ A" (in custom judg at level 80, Γ custom exp, M custom nf, A custom nf).
Reserved Notation "Γ '⊢a' M ⟸ A" (in custom judg at level 80, Γ custom exp, M custom nf, A custom nf).
...
with alg_type_check_mut_ind := Induction for alg_type_check Sort Prop
