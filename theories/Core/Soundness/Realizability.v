...
Proof.
  ...
  - handle_functional_glu_sort_elem P.
    ...
    + intros.
      ...
      * handle_functional_glu_sort_elem P.
        assert {{ Δ, IT[σ]@s1 ⊢w Id : Δ, IT[σ]@s1 }} by mauto 3.
        assert {{ Δ, IT[σ]@s1 ⊢ OT[σ∘Wk,,#0] ® glu_typ_top pred_P s2 b }}  as [] by mauto 3.
        assert ({{ Δ, IT[σ]@s1 ⊢ OT[σ∘Wk,,#0][Id] ≈ B' : Sort@s2 }}) by mauto 4.
        mauto 4.
