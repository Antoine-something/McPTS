...
Create HintDb mcpts discriminated.
...
Ltac Tauto.intuition_solver ::= auto with mcpts core solve_subterm.
...
Ltac bulky_rewrite1 :=
  match goal with
  | H : _ |- _ => rewrite H
  | _ => progress (autorewrite with mcpts)
  end.
...
Ltac bulky_rewrite_in1 HT :=
  ...
  | _ => progress (autorewrite with mcpts in HT)
  end.
