...
Function spaces $\tppi A B$ is the only type constructor, and can represent simple, dependent, or polymorphic functions.
...
Moreover, we use a context lookup judgment, denoted $\ctxlookup \Gamma {x_i} A$.
