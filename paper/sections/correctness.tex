...
\subsubsection{Properties of the gluing model}

The first property states that our gluing model is indeed stable under weakenings:
...
\begin{lemma}[Monotonicity]
  ...
  \item If $\glutmjudg \Gamma M A m {El}$ and $\wfwk \Delta \sigma \Gamma$, then $\glutmjudg \Delta {\tmclo M} {\tmclo A} m {El}$
  \end{enumerate}
\end{lemma}
\begin{proof}
