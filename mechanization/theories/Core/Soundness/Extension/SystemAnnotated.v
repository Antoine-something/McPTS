...
Inductive wf_exp_ann {P} : ctx P -> typ P -> P -> exp P -> Prop :=
(** Sorts *)
| wfa_st :
...
#[export]
Hint Constructors wf_exp_ann wf_typ_ann : mcpts.

Scheme wf_exp_ann_mut_ind := Induction for wf_exp_ann Sort Prop
with wf_typ_ann_mut_ind := Induction for wf_typ_ann Sort Prop.
Combined Scheme syntacticwf_ann_mut_ind from
  wf_exp_ann_mut_ind,
  wf_typ_ann_mut_ind.
