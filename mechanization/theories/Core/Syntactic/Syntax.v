...
| a_lam : Exp P -> Exp P                                                (* λM *)
| a_app : Exp P -> Exp P -> Exp P                                       (* M N *)
| a_clo : Sub P -> Exp P -> Exp P                                       (* [σ]M *)
(* This is a special expression that characterizes all sorts *)
| a_typ : Exp P
...
(* Types and kinds are shorthands for expressions *)
Definition Typ (P : PtsSig) := Exp P.
Definition Knd (P : PtsSig) := Exp P.

(* Assumptions in contexts have a well-kinded types *)
...
Notation "'Type'" := (a_typ) (in custom Exp at level 0) : mcpts_scope.
...
Notation "'Type'" := (nf_typ) (in custom Nf at level 0) : mcpts_scope.
