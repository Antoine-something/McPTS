...
(* All of the following lemmas about subtyping should be replaced with lemmas about type equality 
 * But this essentially means proving the whole presupposition lemma, so we will do it later intead
 *)
...
(* #[export] *)
(* Hint Resolve wf_exp_subtyp' : mcpts. *)
(* #[export] *)
(* Remove Hints wf_exp_subtyp : mcpts. *)
...
(* #[export] *)
(* Hint Resolve wf_sub_subtyp' : mcpts. *)
(* #[export] *)
(* Remove Hints wf_sub_subtyp : mcpts. *)
...
(* #[export] *)
(* Hint Resolve wf_exp_eq_subtyp' : mcpts. *)
(* #[export] *)
(* Remove Hints wf_exp_eq_subtyp : mcpts. *)
...
(* #[export] *)
(* Hint Resolve wf_sub_eq_subtyp' : mcpts. *)
(* #[export] *)
(* Remove Hints wf_sub_eq_subtyp : mcpts. *)
