...
(* It would be better if could get {{ Γ ⊢ Π r A B ≈ C : Sort@s3, but that does not seem to be possible *)
...
(* Again, it would be nicer to obtain {{ Γ ⊢ A' ≈ A }}, but it does not seem possible *)
