...
| d_sort : P -> domain P
| d_pi : domain P -> env P -> exp P -> domain P
| d_fn : env P -> exp P -> domain P
(* | d_nat : domain P *)
(* | d_zero : domain P *)
...
Module Domain_Notations.
  ...
  Notation "'Π' a ρ B" := (d_pi a ρ B) (in custom domain at level 0, a custom domain at level 30, ρ custom domain at level 0, B custom exp at level 30) : mcpts_scope.
  Notation "'λ' ρ M" := (d_fn ρ M) (in custom domain at level 0, ρ custom domain at level 30, M custom exp at level 30) : mcpts_scope.
