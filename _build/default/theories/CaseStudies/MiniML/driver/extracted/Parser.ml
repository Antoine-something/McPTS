...
module Gram =
 struct
  ...
  | Prod'obj'1 ->
    Obj.magic (Coq_existT
      ((Obj.magic (Coq_obj'nt, ((NT Coq_ann_obj'nt) :: ((T ARROW't) :: ((NT
         Coq_param'nt) :: ((T LAMBDA't) :: [])))))),
      (Obj.magic (fun ann_obj _ param _ -> Cst.Coq_fn ((fst param),
        (snd param), (snd ann_obj), (fst ann_obj))))))
  | Prod'obj'0 ->
    Obj.magic (Coq_existT
      ((Obj.magic (Coq_obj'nt, ((NT Coq_obj'nt) :: ((T ARROW't) :: ((NT
         Coq_params'nt) :: ((T PI't) :: [])))))),
  ...
  | Prod'atomic_obj'0 ->
    Obj.magic (Coq_existT
      ((Obj.magic (Coq_atomic_obj'nt, ((T TYPE't) :: []))),
      (Obj.magic (fun _ -> Cst.Coq_st))))
  | Prod'app_obj'1 ->
    Obj.magic (Coq_existT
  ...
  | Ninit n ->
    (match n with
     ...
     | Nis'45 ->
       Lookahead_act (fun terminal0 ->
         match terminal0 with
         | Coq__2.DARROW't -> Shift_act Nis'46
         | _ -> Fail_act)
     | Nis'44 ->
       Lookahead_act (fun terminal0 ->
         match terminal0 with
     ...
     | Nis'4 ->
       Lookahead_act (fun terminal0 ->
         ...
         | Coq__2.ZERO't -> Shift_act Nis'1
         | _ -> Fail_act)
     | Nis'3 -> Default_reduce_act Coq__2.Prod'atomic_obj'0
