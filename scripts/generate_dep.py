...
def gen_graph() -> str:
    ...
    return textwrap.dedent(f"""
      digraph McPTS {{
        graph [center=true,class="depgraph",cluster=true,fontname="Open Sans",fontsize=28,label="McPTS",labeljust=l,labelloc=t,penwidth=2,size=15,splines=true,tooltip=""];
